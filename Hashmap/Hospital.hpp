...
//
// ******************PUBLIC OPERATIONS*********************
// bool addUnit( unit )              --> Add unit to the hospital
// CareUnit getServiceUnit( name )   --> Get CareUnit object
// CareUnit getCriticalUnit( )       --> Get Critical Care Unit's object
// vector<CareUnit> getUnits( )      --> Get vector of all units present in the hospital
...
public:
    ...
    /**
     * O(1)
     * @return a vector of the units' present in the hospital
     * */
